...
urlpatterns = [
    ...
    path('patient/<str:patient_id>/history/', views.patient_history, name='patient_history'),
    ...
    # 2. VISITS
    # =========================
    path('visit/create/<str:patient_id>/', views.create_visit, name='create_visit'),
    path('visit/<int:visit_id>/', views.visit_detail, name='visit_detail'),

    # =========================
    # 3. DOCTOR
    # =========================
    path('doctor/<int:visit_id>/', views.add_doctor, name='add_doctor'),

    # =========================
    # 4. LAB
    # =========================
    path('lab/<int:visit_id>/', views.add_lab, name='add_lab'),
